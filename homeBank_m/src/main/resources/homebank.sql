...
insert  into `menu`(`id`,`menuname`,`url`,`parentid`) 
values (1,'基础信息管理',NULL,1),(2,'基础数据','jsp/datadict.jsp',1),(3,'收支管理',NULL,3),(4,'收入管理','jsp/income.jsp',3),(5,'支出管理','jsp/payout.jsp',3),(6,'预算管理',NULL,6),(7,'预算设定','jsp/buget.jsp',6),(8,'借入借出','jsp/borrow.jsp',3);
